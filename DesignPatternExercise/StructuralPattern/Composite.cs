...
namespace DesignPatternExercise.StructuralPatterns
{
    ...
    {
        protected List<Component> childrenlist = new List<Component>();
        ...
        public override string Operation()
        {
            ...
            foreach (Component child in childrenlist)
            {
    ...
    class CompositeUser
    {
        ...
        // interface.
        public void ClientCode(Component child)
        {
            Console.WriteLine($"RESULT: {child.Operation()}\n");
        }
        ...
        // classes.
        public void ClientCode2(Component child1, Component child2)
        {
            if (child1.IsComposite())
            {
                child1.Add(child2);
            }

            Console.WriteLine($"RESULT: {child1.Operation()}");
        }
    }
    ...
    class CompositeClient
    {
        ...
        {
            CompositeUser client = new CompositeUser();
            ...
            Console.WriteLine("Client: Add a leaf to the current composite tree");
